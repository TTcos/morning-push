...
# ======================== 3. 限行（自动轮换 + 节假日/调休）========================
# 法定节假日（不限行）列表格式：'2026-05-01', '2026-05-04', ...
# 调休工作日（需要限行）列表格式：'2026-04-26', '2026-05-09', ...
# 每年需根据国务院安排手动更新一次（通常在年底发布次年节假日安排）
    ...
    for t in todos:
        ...
        # 3. 每月固定日 "monthly:20"
            ...
            try:
                ...
                pass
        # 4. 每周固定日 "weekly:0" ~ "weekly:6" (0=周一, 6=周日)
